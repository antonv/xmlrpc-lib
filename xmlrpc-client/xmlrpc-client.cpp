// xmlrpc-client.cpp: определяет точку входа для приложения.
//
                   ...
                   int       nCmdShow)
{
	...
	HACCEL hAccelTable;
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_XMLRPCCLIENT));
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
	...
	wc.hIcon         = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_XMLRPCCLIENT));
	wc.hCursor       = 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    LoadString(hInstance, IDC_XMLRPCCLIENT, szWindowClass, MAX_LOADSTRING);
